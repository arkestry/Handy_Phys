...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("<!--\n");
      out.write("Teniendo la tabla en base de datos\n");
      out.write("\n");
      out.write("CREATE TABLE `members` (\n");
      out.write("  `id` int(10) unsigned NOT NULL auto_increment,\n");
      out.write("  `first_name` varchar(45) NOT NULL,\n");
      out.write("  `last_name` varchar(45) NOT NULL,\n");
      out.write("  `email` varchar(45) NOT NULL,\n");
      out.write("  `uname` varchar(45) NOT NULL,\n");
      out.write("  `pass` varchar(45) NOT NULL,\n");
      out.write("  `regdate` date NOT NULL,\n");
      out.write("  PRIMARY KEY  (`id`)\n");
      out.write(") ENGINE=InnoDB DEFAULT CHARSET=latin1;\n");
      out.write("-->");
    } catch (Throwable t) {
